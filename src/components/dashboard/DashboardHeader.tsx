...
export const DashboardHeader = ({ isAdmin, misHospitalesLength, filtroHospitalId, setFiltroHospitalId, hospitalesDisponibles, filtroPlanta, setFiltroPlanta }: Props) => {
    return (
