...
import { UsuariosAsignacionForm } from "./UsuariosAsignacionForm";
...
export const UsuariosManager = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <UsuariosTabla 
                gestores={gestores} gestorEditando={gestorEditando} 
                loading={loading} onEdit={iniciarEdicion} onDelete={solicitarBorrado} 
            />
