                ...
                <table className="w-full text-left border-collapse min-w-[600px]">
                    ...
                    <tbody className="text-sm">
                                ...
                                <tr key={gestor.id} className={`border-b border-border last:border-0 transition-colors ${isSelected ? 'bg-primary/5' : 'hover:bg-muted/50'}`}>
                                    ...
                                    <td className="p-4">
                                        <div className="flex items-center gap-1.5 text-muted-foreground font-medium">
                                            ...
                                            <span>{formatFecha(gestor.ultimo_acceso)}</span>
                                        </div>
                                    </td>
                        ...
                        {gestores.length === 0 && !loading && (
                            <tr>
                                <td colSpan={4} className="p-8 text-center text-muted-foreground">Aún no hay ningún gestor registrado en la plataforma.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
