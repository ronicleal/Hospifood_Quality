import { SupabaseGestorRepository } from "../supabase/SupabaseGestorRepository";
...
import type { GestorRepository } from "./GestorRepository";
...
export function createGestorRepository(): GestorRepository {
    return new SupabaseGestorRepository();
}
